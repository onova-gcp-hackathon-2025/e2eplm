...
from .sub_agents.pdf_archivist import pdf_archivist_agent
from .sub_agents.requirements_curator import requirements_curator_agent
...
root_agent = LlmAgent(
    ...
    tools=[
        AgentTool(agent=pdf_archivist_agent),
        AgentTool(agent=requirements_curator_agent),
